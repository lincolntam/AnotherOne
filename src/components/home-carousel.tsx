...
export function HomeCarousel({ websites, onOpen }: HomeCarouselProps) {
  ...
  return (
    <section className="mb-8">
      <motion.div className="-mx-5 flex snap-x gap-5 overflow-x-auto px-5 pb-5 pt-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden" layout>
        {display.map((website) => (
          <div key={website.id} className="w-[72%] shrink-0 snap-center">
